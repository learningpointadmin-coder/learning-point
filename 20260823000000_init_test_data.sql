...
-- ⚠️ IMPORTANT: is_correct column kabhi student ko send nahi hota.
...
-- ============================================================================
-- libSQL notes:
--   • Booleans → INTEGER (0/1). Boolean → INTEGER (0/1).
--   • Timestamps → TEXT ISO-8601 via datetime('now').
--   • Foreign keys need `pragma foreign_keys=on;` per connection.
--   • No RETURNING needed for app; libSQL supports it if required.
-- ============================================================================
